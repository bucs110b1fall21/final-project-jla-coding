...
class ComputerScreen:
    ...
    def buy(self):
        self.player.crypto += self.player.cash * self.percentage / self.economy.rate
        self.player.cash = self.player.cash * self.percentage
    
    def sell(self):
        self.player.crypto = self.player.crypto * self.percentage
        self.player.cash += self.player.crypto * self.percentage * self.economy.rate
